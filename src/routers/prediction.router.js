...
predictionRouter.post("/api/predictions", authHandler, predictionController.createOnePrediction);
predictionRouter.patch("/api/predictions/:id", authHandler, predictionController.patchOnePrediction);
predictionRouter.delete("/api/predictions/:id", authHandler, predictionController.deleteOnePrediction);
